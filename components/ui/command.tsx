...
function CommandInput({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.Input>) {
    return (
        <div className="flex h-10 items-center gap-2 border-b px-4" data-slot="command-input-wrapper">
            <svg aria-hidden className="size-4 shrink-0 opacity-50" fill="none" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                <path
                    clipRule="evenodd"
...
function CommandEmpty({ ...props }: React.ComponentProps<typeof CommandPrimitive.Empty>) {
    return <CommandPrimitive.Empty className="py-8 text-center font-mono text-sm" data-slot="command-empty" {...props} />;
}
...
function CommandSeparator({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.Separator>) {
    return <CommandPrimitive.Separator className={cn('h-px bg-border', className)} data-slot="command-separator" {...props} />;
}
