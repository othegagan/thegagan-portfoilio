        ...
        <div className={cn('relative z-0 flex min-h-[40vh] w-full flex-col  overflow-hidden rounded-md bg-background', className)}>
            <div className='scale-y-40 relative isolate z-0 flex w-full flex-1 items-start justify-center opacity-70 '>
                <motion.div
                    ...
                    className='bg-gradient-conic absolute inset-auto right-1/2 h-36 w-[30rem] overflow-visible from-orange-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]'>
                ...
                <motion.div
                    ...
                    className='bg-gradient-conic absolute inset-auto left-1/2 h-36 w-[30rem] from-transparent via-transparent to-orange-500 text-white [--conic-position:from_290deg_at_center_top]'>
