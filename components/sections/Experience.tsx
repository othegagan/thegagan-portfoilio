...
export default function Experience() {
	...
	return (
		<div className="container relative  pb-12 pt-6 ">
			{timeline.map((item) => (
				<div
					className=" mx-auto hidden max-w-5xl cursor-default justify-end gap-x-3 md:flex"
					key={item.id}
				>
					...
					<div className="grow pb-8 pt-0.5">
						<h2 className="flex gap-x-1.5 text-lg font-semibold  text-white">
							{item.title}
						</h2>
						<Link href={item.link}>
			...
			>
				<div className="absolute bottom-0 left-1/2 -z-10 -translate-x-1/2">
					<Image
						src={GlowBottom}
						className="max-w-none opacity-30 grayscale"
						width={1404}
						height={658}
