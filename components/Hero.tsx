...
const Hero = () => {
    return (
        <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 pt-24">
            <div>
                ...
                <h2 className="mt-3 text-lg font-medium tracking-tight  sm:text-xl">Lead Engineer at Upstatement</h2>
                    ...
                    <ul className="mt-16 w-max">
                        <li>
                            <a className="group flex items-center py-3 active" href="#about">
                                ...
                                <span className="nav-text text-xs font-bold uppercase tracking-widest text-zinc-500 group-hover: group-focus-visible:">About</span>
                            </a>
                        </li>
                        <li>
                            <a className="group flex items-center py-3" href="#experience">
                                <span className="nav-indicator mr-4 h-px w-8 bg-zinc-600 transition-all group-hover:w-16 group-hover:bg-zinc-200 group-focus-visible:w-16 group-focus-visible:bg-zinc-200 motion-reduce:transition-none"></span>
                                <span className="nav-text text-xs font-bold uppercase tracking-widest text-zinc-500 group-hover: group-focus-visible:">Experience</span>
                            </a>
                        </li>
                        <li>
                            <a className="group flex items-center py-3" href="#projects">
                                <span className="nav-indicator mr-4 h-px w-8 bg-zinc-600 transition-all group-hover:w-16 group-hover:bg-zinc-200 group-focus-visible:w-16 group-focus-visible:bg-zinc-200 motion-reduce:transition-none"></span>
                                <span className="nav-text text-xs font-bold uppercase tracking-widest text-zinc-500 group-hover: group-focus-visible:">Projects</span>
                            </a>
                        </li>
                    </ul>
                </nav>
            ...
            <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
                <li className="mr-5 text-xs">
                    <a className="block hover:" href="https://github.com/bchiang7" target="_blank" rel="noreferrer">
                ...
                <li className="mr-5 text-xs">
                    <a className="block hover:" href="https://instagram.com/bchiang7" target="_blank" rel="noreferrer">
                ...
                <li className="mr-5 text-xs">
                    <a className="block hover:" href="https://twitter.com/bchiang7" target="_blank" rel="noreferrer">
                ...
                <li className="mr-5 text-xs">
                    <a className="block hover:" href="https://www.linkedin.com/in/bchiang7/" target="_blank" rel="noreferrer">
