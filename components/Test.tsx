...
const Skillset = () => {
    ...
    const scaleProgess = useTransform(scrollYProgress, [1, 0], [0.7, 1.6]);
    const scaleProgess1 = useTransform(scrollYProgress, [1, 0], [0.7, 1.3]);
    const scaleProgess2 = useTransform(scrollYProgress, [1, 0], [0.7, 1.1]);
